    ...
    <section class="ftco-section ftco-book ftco-no-pt ftco-no-pb">
    	<div class="container">
	    	<div class="row justify-content-end">
                ...
                <div class="col-md-12">
									<div class="form-group">
			              <input type="button" value="Sign Up" onclick="location.href='./login/register.jsp'" class="btn btn-primary py-3 px-4">
			            </div>
								</div>
							</div>
	    			</form>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">난바</h3><br>
                <p>맛집이 많기로 소문난 곳</p><br><br>
                <p><a href="#" class="btn btn-primary">바로가기</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">신사이바시</h3><br>
                <p>시장이 넓어 돌아다닐 곳이 많은 곳</p><br><br>
                <p><a href="#" class="btn btn-primary">바로가기</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">우메다</h3><br>
                <p>재미있는 놀거리나 볼거리가 많은 곳</p><br><br>
                <p><a href="#" class="btn btn-primary">바로가기</a></p>
              </div>
            </div>
          </div>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
	    						...
	    						<h3 class="mb-3"><a href="rooms.html">초 밥</a></h3>
	    						<ul class="list-accomodation">
	    							<li><span>많은 사람들이 일본하면 떠오르는 음식!</span></li>
	    							<li><span>초밥은 어떠신가요</span></li><br>
	    							<!-- <li><span>View:</span> Sea View</li>
	    							<li><span>Bed:</span> 1</li> -->
	    						</ul>
	    						<p class="pt-1"><a href="room-single.html" class="btn-custom px-3 py-2">맛집 보러가기 <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			</div>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
    							<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
	    						<h3 class="mb-3"><a href="rooms.html">라 멘</a></h3>
									<ul class="list-accomodation">
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half right-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
    							<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
	    						<h3 class="mb-3"><a href="rooms.html">규카츠</a></h3>
									<ul class="list-accomodation">
	    							<!-- <li><span>Max:</span> 3 Persons</li>
	    							<li><span>Size:</span> 45 m2</li>
	    							<li><span>View:</span> Sea View</li>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half right-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
    							<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
	    						<h3 class="mb-3"><a href="rooms.html">오코노미야키</a></h3>
									<ul class="list-accomodation">
	    							<!-- <li><span>Max:</span> 3 Persons</li>
	    							<li><span>Size:</span> 45 m2</li>
	    							<li><span>View:</span> Sea View</li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						<h2 class="footer-heading"><a href="#" class="logo">Osaka Gurume</a></h2>
